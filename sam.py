    ...
    def solve_capture(self):
        ...
        payload = {
            "contents": [{
                "parts": [
                    {
                        "text": "Analyze the given communication question. Identify whether it is speaking, listening, reading comprehension, grammar, or writing. For speaking or listening-type questions, provide the best possible response in clear, simple English. For grammar or reading questions, select the correct option and give a brief one-line explanation. For writing tasks, generate a short, professional response (70–120 words). Do NOT add extra details outside the required answer."
                    },
